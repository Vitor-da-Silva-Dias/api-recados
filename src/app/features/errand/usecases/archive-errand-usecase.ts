...
export class archiveErrandUsecase implements Usecase {
    public async execute(params: ArchiveErrandParams): Promise<Result> {
        ...
        if (errand.archived === false) {
          ...
          return UsecaseResponse.BadRequest("Errand already archived");
        }
