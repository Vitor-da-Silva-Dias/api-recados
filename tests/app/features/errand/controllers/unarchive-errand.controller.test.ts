...
describe("Errand Controller - UNARCHIVE", () => {
    ...
    test("deveria retornar falha caso o usuário não seja encontrado", async () => {
        ...
        const result = await request(sut).post("/users/:userId/errands/:errandId/unarchive").send()
    ...
    test("deveria retornar falha caso o recado não seja encontrado", async () => {
        ...
        const result = await request(sut).post(`/users/${user.userId}/errands/:errandId/unarchive`)
        .send()
    ...
    test("deveria retornar sucesso caso o recado seja desarquivado", async () => {
        ...
        expect(result.body).toHaveProperty("message", "Errand successfully unarchived");
